...
class Wizard(models.TransientModel):
	...
	id_idea = fields.Many2one('employee.ideas',string='Ideas',required=True,default='1',readonly=True)

	department = fields.Many2one('hr.department', string="Department", required=True, default='1', readonly=True)
	employee = fields.Many2one('hr.employee', string="Employee", required=True, default='1', readonly=True)